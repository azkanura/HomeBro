...
<div class="page-header">
  <h3 class="page-title">Station Detail</h3>
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
    <li class="breadcrumb-item"><a href="{{url('/stations')}}">Stations</a></li>
    <li class="breadcrumb-item active">Station Detail</li>
  </ol>
</div>
@endsection
@section('content')
      ...
      <div class="panel-body">
          ...
          <div class='row panel-content'>
            ...
            <div class='col-md-8' style='padding:15px 45px 10px 30px'>
              ...
              {{$value}}
              @else
              <a href={{$value}} class='btn btn-primary'><i class='fa fa-map'></i>&nbsp;&nbsp;&nbsp;See on Map</a>
              @endif
            </div>
          </div>
          @endif
