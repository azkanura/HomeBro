...
<div class="page-header">
  <h3 class="page-title">Stations</h3>
  <ol class="breadcrumb">
  ...
  <div class='col-md-3'>
    <div class="card card-shadow">
      <div class="user-base card-block">
        ...
        <a href="{{url('stations')}}/{{$station->id}}" class="btn btn-sm btn-icon btn-success on-editing cancel-row"><i class="icon wb-eye" aria-hidden="true"></i>&nbsp;&nbsp;Detail</a>
      </div>
    </div>
  </div>
  @endforeach
